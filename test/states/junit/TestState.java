...
public class TestState {
	...
	public void changeState() {
		...
		Subject s = new Subject(Type.PIG);
		State h = new Healthy();
		State si = new Sick();
		...
		for(int i =0;i<Integer.parseInt(Config.getProperty("Pig.Incubation.Sick"));i++)
		{
			s.incubate();
		}
		si.changeState(s);
		...
		for(int i =0;i<Integer.parseInt(Config.getProperty("Pig.Incubation.Contagious"));i++)
		{
			s.incubate();
		}
		c.changeState(s);
		...
		for(int i =0;i<Integer.parseInt(Config.getProperty("Pig.Incubation.Recovering"));i++)
		{
			s.incubate();
		}
		r.changeState(s);
