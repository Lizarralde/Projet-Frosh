...
public class TestSubject {
	...
	@BeforeClass
	/*On crée un fichier de config a des fins de test c'est a dire avec des valeurs extrêmes: 100, 0*/
	...
	public void testChangeStateH() {
		...
		//Normalement ici il n'a pas changé pas d'état car il n'a pas de maladie
		s.changeState();		
	...
	/*On teste le contact entre deux individus
	Dans le fichier properties on a mis le ratio de contagion a 100
	et 0 respectivement */
	@Test
	public void testContact() {
			...
			//Même chose
			Subject s3 = new Subject(Type.DUCK);
			Subject s4 = new Subject(Type.CHICKEN);
			s4.setDisease(Disease.H5N1);
